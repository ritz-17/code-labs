...
class visaulize : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_visaulize)
        btn1 = findViewById(R.id.btn1)

        btn1.setOnClickListener {
            val intent = Intent(this@visaulize, ml::class.java)
    ...
    override fun onTouchEvent(tochevent: MotionEvent): Boolean {
        when (tochevent.action) {
            ...
            MotionEvent.ACTION_UP -> {
                ...
                y2 = tochevent.y
                if (x1 > x2) {
                    val i = Intent(this@visaulize, ml::class.java)
                    startActivity(i)
                }
            }
        }
